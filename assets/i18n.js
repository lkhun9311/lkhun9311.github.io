...
var I18N = (function () {
  ...
  var DICT = {
    ko: {
      ...
      "cv.role1d": "인프라 성격의 백엔드 시스템, Kubernetes 제어면, GPUaaS 플랫폼, 신뢰성 엔지니어링.",
      "cv.role2": "지금 보고 있는 것",
      "cv.role2d": "GPUaaS, Kubernetes 기반 제어면, AI 인프라, 추론 플랫폼, 관측.",
      "cv.role3": "홈페이지와 글",
      "cv.role3d": "이 사이트에서 프로젝트와 기술 글, 엔지니어링 노트를 이어서 정리합니다.",
      "footer.built": "© 2026 이광훈. GitHub Pages 로 만들었습니다.",
      "home.about1": "제어면과 운영 신뢰성, Kubernetes 기반 플랫폼, 그리고 컴퓨트·스토리지·인증·관측을 다루는 실서비스 인터페이스를 중심으로 인프라 성격의 백엔드 시스템을 만듭니다.",
      "home.about2": "지금은 클라우드 백엔드 엔지니어링을 AI 인프라·추론 플랫폼·테넌트 거버넌스·워크로드 운영과 잇는 GPUaaS 프로젝트를 만들고 있습니다.",
      "home.cv": "이력",
      "home.highlights": "요즘 하는 일",
      "home.hl1": "Kubernetes 기반 GPUaaS 제어면을 만들고 있습니다.",
      ...
      "projects.title": "프로젝트",
      "writing.lead": "클라우드 백엔드 시스템, GPU 인프라, Kubernetes 제어면, 관측에 대해 골라 쓴 기술 글입니다.",
      "writing.title": "글"
    },
    ja: {
