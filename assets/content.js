...
(function () {
  ...
  var DATA = {
    ...
    writing: {
      ...
      items: [
        {
          title: "Re-identification Defences on Poll Aggregates Ate Five Tickets",
          url: "writing/until-the-guarantee-was-a-sentence.html",
          title_ko: "투표 집계 재식별 방어에 티켓 다섯 개를 썼습니다",
          ...
          title_ja: "投票集計の再識別防御がチケットを 5 枚使いました",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "빈 목록이 노드 0대인지 조회 실패인지 몰랐습니다",
        ...
        {
          title: "The Monitoring Screen I Said Not to Fix Took 6.8 Seconds",
          url: "writing/monitoring-the-screen-i-said-not-to-fix.html",
          source: "company", sourceLabel: "Company work",
          title_ko: "고칠 게 없다고 쓴 모니터링 화면이 6.8초였습니다",
          ...
          title_ja: "直す必要がないと書いたモニタリング画面が 6.8 秒でした",
        ...
        {
          title: "I Pinned the Load Conditions So Six Runs Would Match",
