    ...
    news: {
      items: [
        ...
        { date: "2026-02-06", dateLabel: "Feb 6, 2026",
          ...
          text_ko: "Kubernetes 기반 GPUaaS 플랫폼 제어면을 만들기 시작했습니다.",
          text_ja: "Kubernetes ネイティブな GPUaaS プラットフォーム制御面を作り始めました。" },
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          title_ko: "GPUaaS 플랫폼 제어면: Kubernetes 기반 AI 인프라",
          title_ja: "GPUaaS プラットフォーム制御面: Kubernetes ネイティブな AI インフラ",
          authors: "Solo",
          date: "2026-02-06",
          ...
          desc_ko: "GPU 기반 AI 워크로드를 위한 제어면 프로젝트입니다. 노드 준비 상태, 테넌트 단위 GPU 거버넌스, 어드미션 제어, 추론 워크로드 관리, 운영 관측을 다룹니다.",
          desc_ja: "GPU ベースの AI ワークロードのための制御面プロジェクトです。ノードの準備状態、テナント単位の GPU ガバナンス、アドミッション制御、推論ワークロード管理、運用の可観測性を扱います。",
        ...
        },
        {
          ...
          title_ko: "IaaS 백엔드 엔지니어링: 클라우드 제어면과 운영",
          title_ja: "IaaS バックエンドエンジニアリング: クラウド制御面と運用",
          authors: "Company",
          date: "2026-01-28",
