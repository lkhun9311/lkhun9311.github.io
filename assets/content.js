...
(function () {
  ...
  var NOTES_NAV = {
    ...
    "cache-stampede": {ko:{t:"Cache Stampede",s:[["무엇","개요",0],["없음","「없음」도 값입니다",0],["막기","막는 자리는 Lock이 아니라 자료구조입니다",0],["쓰인-곳","이 사이트에서 쓰인 곳",0]]}, en:{t:"Cache Stampede",s:[["무엇","Overview",0],["없음","“Nothing” is also a value",0],["막기","The fix belongs to the data structure, not to a lock",0],["쓰인-곳","Where it is used on this site",0]]}, ja:{t:"Cache Stampede",s:[["무엇","概要",0],["없음","「無い」も値です",0],["막기","止める場所はロックではなくデータ構造です",0],["쓰인-곳","このサイトで使われている記事",0]]}},
    "connection-pool": {ko:{t:"Connection Pool",s:[["왜","개요",0],["상한","블로킹 JDBC에서는 이것이 동시성 상한입니다",0],["불변식","불변식 하나",0]]}, en:{t:"Connection Pool",s:[["왜","Overview",0],["상한","On blocking JDBC this is the concurrency limit",0],["불변식","One invariant",0]]}, ja:{t:"Connection Pool",s:[["왜","概要",0],["상한","ブロッキング JDBC ではこれが同時実行の上限",0],["불변식","不変条件が一つ",0]]}},
    "connection-pooler": {ko:{t:"Connection Pooler",s:[["왜","개요",0],["구별","Connection Pool과 다른 것입니다",0],["한계","무엇을 못 고치나",0]]}, en:{t:"Connection Pooler",s:[["왜","Overview",0],["구별","It is not the same as a connection pool",0],["한계","What it cannot fix",0]]}, ja:{t:"Connection Pooler",s:[["왜","概要",0],["구별","Connection Pool とは別のもの",0],["한계","何を直せないか",0]]}},
    "fail-closed": {ko:{t:"Fail-closed",s:[["방향","개요",0],["대가","대가",0],["조용함","조용한 Fail-open이 제일 위험합니다",0]]}, en:{t:"Fail-closed",s:[["방향","Overview",0],["대가","What it costs",0],["조용함","A silent fail-open is the worst case",0]]}, ja:{t:"Fail-closed",s:[["방향","概要",0],["대가","代償",0],["조용함","静かな Fail-open が一番危ない",0]]}},
    "fencing": {ko:{t:"Fencing",s:[["왜","개요",0],["어떻게","어떻게 끄나요?",0],["없으면","경로가 없으면 복구도 없습니다",0],["쓰인-곳","이 사이트에서 쓰인 곳",0]]}, en:{t:"Fencing",s:[["왜","Overview",0],["어떻게","How it is done",0],["없으면","No path means no recovery",0],["쓰인-곳","Where it is used on this site",0]]}, ja:{t:"Fencing",s:[["왜","概要",0],["어떻게","どうやって切るか",0],["없으면","経路が無ければ復旧も無い",0],["쓰인-곳","このサイトで使われている記事",0]]}},
    "grace-period": {ko:{t:"Grace Period",s:[["무엇","개요",0],["누가","값을 적는 쪽은 회수당하는 쪽입니다",0],["상한","상한을 두는 것이 가장 약하고 가장 정직한 수리입니다",0],["쓰인-곳","이 사이트에서 쓰인 곳",0]]}, en:{t:"Grace Period",s:[["무엇","Overview",0],["누가","The side being reclaimed writes the value",0],["상한","A cap is the weakest and the most honest repair",0],["쓰인-곳","Where it is used on this site",0]]}, ja:{t:"Grace Period",s:[["무엇","概要",0],["누가","値を書くのは回収される側です",0],["상한","上限を置くのが最も弱く、最も正直な修理です",0],["쓰인-곳","このサイトで使われている記事",0]]}},
    "load-test-harness": {ko:{t:"Harness",s:[["뜻","개요",0],["조건","무엇이 Harness를 Harness로 만드나",0],["흐름","어떻게 도나: 실행 한 번의 흐름",0],["오해","흔한 오해",0]]}, en:{t:"Harness",s:[["뜻","Overview",0],["조건","What makes a harness a harness",0],["흐름","How one run goes",0],["오해","Common misreadings",0]]}, ja:{t:"Harness",s:[["뜻","概要",0],["조건","何が Harness を Harness にするのか",0],["흐름","どう回るか — 実行一回の流れ",0],["오해","よくある誤解",0]]}},
    ...
    "swap": {ko:{t:"Swap",s:[["무엇","개요",0],["점유","꽉 찬 것은 정황이지 원인이 아닙니다",0],["끄기","끄는 명령은 되돌릴 준비를 하고 씁니다",0],["쓰인-곳","이 사이트에서 쓰인 곳",0]]}, en:{t:"Swap",s:[["무엇","Overview",0],["점유","Full is circumstance, not cause",0],["끄기","Turning it off needs an undo written first",0],["쓰인-곳","Where it is used on this site",0]]}, ja:{t:"Swap",s:[["무엇","概要",0],["점유","埋まっているのは状況で、原因ではありません",0],["끄기","切る命令は戻す手順を先に書きます",0],["쓰인-곳","このサイトで使われている記事",0]]}},
    "timeout": {ko:{t:"Timeout",s:[["두-종류","개요",0],["설정값","설정값은 측정값이 아닙니다",0],["상한","상한에 걸린 값은 지연이 아닙니다",0],["쓰인-곳","이 사이트에서 쓰인 곳",0]]}, en:{t:"Timeout",s:[["두-종류","Overview",0],["설정값","A configured value is not a measured one",0],["상한","A value pinned to the ceiling is not a latency",0],["쓰인-곳","Where it is used on this site",0]]}, ja:{t:"Timeout",s:[["두-종류","概要",0],["설정값","設定値は測定値ではありません",0],["상한","上限に貼り付いた値は遅延ではありません",0],["쓰인-곳","このサイトで使われている記事",0]]}},
    "transaction-pooling": {ko:{t:"Transaction Pooling",s:[["모드","개요",0],["성질","핵심 성질: 언제 묶이나",0],["핀","핀(Pin)이 걸리는 패턴",0]]}, en:{t:"Transaction Pooling",s:[["모드","Overview",0],["성질","The property that matters — when it pins",0],["핀","Patterns that Pin",0]]}, ja:{t:"Transaction Pooling",s:[["모드","概要",0],["성질","核心的な性質 — いつ固定されるか",0],["핀","ピン(Pin)がかかるパターン",0]]}},
    "ttl": {ko:{t:"TTL",s:[["세-곳","개요",0],["만료","만료는 「없음」이 아니라 「모름」입니다",0],["보안","공개 집계에서는 성능 손잡이가 아니라 보안 손잡이입니다",0],["쓰인-곳","이 사이트에서 쓰인 곳",0]]}, en:{t:"TTL",s:[["세-곳","Overview",0],["만료","Expiry means unknown, not absent",0],["보안","For published aggregates it is a security knob, not a performance one",0],["쓰인-곳","Where it is used on this site",0]]}, ja:{t:"TTL",s:[["세-곳","概要",0],["만료","期限切れは「無い」ではなく「分からない」です",0],["보안","公開集計では性能のつまみではなく安全のつまみです",0],["쓰인-곳","このサイトで使われている記事",0]]}},
    "warmup": {ko:{t:"Warm-up",s:[["원인","개요",0],["길이","얼마나 버리나",0]]}, en:{t:"Warm-up",s:[["원인","Overview",0],["길이","How much to throw away",0]]}, ja:{t:"Warm-up",s:[["원인","概要",0],["길이","どれだけ捨てるか",0]]}}
  };
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          desc_ko: "GPU 기반 AI 워크로드를 위한 Control Plane 프로젝트입니다. Node 준비 상태, 테넌트 단위 GPU 거버넌스, 어드미션 제어, 추론 워크로드 관리, 운영 관측을 다룹니다.",
    ...
    writing: {
      ...
      items: [
        ...
        },
        {
          ...
          desc_ko: "상위 인증 Portal이 500을 내면서 Session 만료를 밀어 보냈고 사용자가 조용히 튕겼습니다. 뒤이어 나온 처방 「검증이 안 되면 로그아웃」은 계속 쓰고 있는 사용자만 쫓아냅니다. Polling을 브라우저가 돌리므로 위험이 진짜인 순간에 오히려 멈추기 때문입니다.",
        ...
        },
        {
          ...
          desc_ko: "축마다 방어를 쓰면 축이 하나 늘 때 자동으로 뚫립니다. min-n은 인구 축에만 걸려 있었고 시간 축은 나중에 생겼습니다. 잔차를 파는 데는 종료 조건이 없어서 보장선을 문장으로 쓰고 나서야 남은 일이 유한해졌습니다.",
          title_ja: "投票集計の再識別防御を軸ごとに立てて 5 回破られました",
        ...
        },
        {
          ...
          source: "side", sourceLabel: "Personal project",
          title_ko: "AWS GPU 랩 비용 오류를 잡은 것은 예산 알람뿐이었습니다",
          desc_ko: "개인 AWS GPU 랩 계정의 비용 통제 기록. 손으로 만든 예산 알람 하나가 제 추정에서 통째로 빠져 있던 항목을 찾아냈고 Terraform이 그 알람을 조용히 지울 뻔했습니다.",
          title_ja: "AWS GPU ラボのコスト誤りを捕まえたのは予算アラートだけでした",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "2,255 Commit을 건너뛴 이관에서 절차서 세 편이 틀렸습니다",
          desc_ko: "2,255 Commit을 건너뛰는 버전 이관. 문서 추론으로는 어디서 깨질지 알 수 없어 격리 환경에 옛 버전을 세우고 한 번 깨뜨려 봤습니다. 그러자 제 앞선 문서 세 편의 전제가 틀렸다는 게 나왔습니다.",
          title_ja: "2,255 コミットを飛ばす移行で手順書 3 本が誤っていました",
        ...
        },
        {
          ...
          source: "side", sourceLabel: "Personal project",
          title_ko: "고쳤다고 보고한 GPU 가드 4건이 Commit에 없었습니다",
          desc_ko: "처음으로 돈을 내고 GPU를 빌리기 직전에, 완료로 보고한 가드 4건이 코드에서는 그 모습이 아니었습니다. 셋은 과금이 계속되는 것을 막는 장치입니다. 저장소에 물어보니 넷 다 제 Commit에서 처음 들어왔는데 git은 잃어버린 편집과 하지 않은 편집을 가르지 못합니다. 나머지를 세는 스크립트를 짰더니 이번엔 판정식이 틀렸습니다.",
        ...
        },
        {
          ...
          source: "commercial", sourceLabel: "Commercial project",
          title_ko: "head -c가 한글을 쪼개서 설계 리뷰가 안 돌았습니다",
          desc_ko: "설계 문서를 고치면 외부 리뷰가 자동으로 돌게 해 뒀습니다. 폴더에는 결과가 쌓이고 있었는데 head -c가 글자가 아니라 바이트를 세는 바람에 잘린 자리가 글자 한가운데였습니다. 6만 바이트를 넘긴 Commit 4개를 재 보니 전부 그랬습니다. 그리고 같은 결함을 저는 세 번 틀리게 적었습니다.",
          title_ja: "head -c が文字を割って設計レビューが走りませんでした",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "통합 모니터링 성능 개선 05. 공유 Cache 설계: 단일 Producer 통합을 지탱하는 세 가지 계약",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "통합 모니터링 성능 개선 04. 화면 완료 조건: REST Response 개선 후에도 SSE 첫 데이터가 정하는 체감 하한",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "통합 모니터링 성능 개선 03. 빈 Metric 판별: 수집 실패와 실제 0대를 구분해 정상값 유지",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "통합 모니터링 성능 개선 02. Cache 동시성 설계: 공유 Snapshot에서 생길 수 있는 세 가지 경합",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "통합 모니터링 성능 개선 01. 사용자 체감 지연: REST Response 이후 기다리는 SSE Connection 첫 데이터",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "모니터링 화면 3개를 고치지 않기로 한 판단은 후속 글에서 틀린 것으로 드러났습니다",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "역할 목록 조회에 1,409ms가 걸린 원인은 없는 프로젝트 ID마다 전체 목록을 다시 조회했기 때문입니다",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "Instance 목록 조회가 54초 걸린 원인은 코드가 아니라 Swap 포화와 삭제 표시된 1,021개 행이었습니다",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "Volume 목록 조회가 10분 만에 Timeout된 원인은 외부 API를 기다리며 키 하나를 잠근 Cache였습니다",
        ...
        },
        {
          ...
          source: "side", sourceLabel: "Personal project",
          title_ko: "회수 정책은 소유자를 120 ms 만에 입장시켰고 장치는 10s 뒤에 왔습니다",
          desc_ko: "테넌트 예산을 한 번 선언하고 일의 종류마다 다른 엔진이 집행합니다. Kueue의 회수 손잡이를 같은 원장에서 양방향으로 쟀더니, 끄면 낭비 0에 소유자 10.1s 대기, 켜면 120 ms 입장에 39.3 GPU-초 폐기였습니다. 그 두 번째 숫자에 대한 첫 발표가 「왜」를 틀렸고 적대적 리뷰가 만든 대조 실험이 그것을 고쳤습니다. 숫자는 살아남고 메커니즘은 죽었습니다.",
          date: "2026-09", dateLabel: "Sep 2026",
        ...
        },
        {
          ...
          source: "side", sourceLabel: "Personal project",
          title_ko: "kubelet을 멈췄더니 46s 만에 Node가 격리됐습니다",
          desc_ko: "GPU Node의 「Ready」가 무엇에 대한 주장이어야 하는지를 CRD로 명시했습니다. 관측을 먼저 집행을 나중에 두 단계로 만들었고 cordon·유예 기간·결함 신호 트리거·자동 drain 네 가지는 미룬 것이 아니라 거절했습니다. kind 워커의 kubelet을 멈추자 Ready → Quarantine → Ready가 0s·46s·48초에 나왔고 그 46초가 컨트롤러가 아니라는 것은 측정이 아니라 설계에서 읽은 것이라고 적었습니다.",
          date: "2026-09", dateLabel: "Sep 2026",
    ...
    notes: {
      ...
      items: [
        ...
        },
        {
          ...
          desc_ko: "ConcurrentHashMap이 키가 속한 Bucket 하나만 잠그는 방식. computeIfAbsent의 매핑 함수가 그 잠금 안에서 돌기 때문에 거기서 외부 호출을 하면 왕복 시간 내내 Bucket이 잠깁니다.",
        ...
        },
        {
          ...
          desc_ko: "행을 없애지 않고 삭제 표시만 바꾸는 방식. 조회에서는 사라지고 Table에는 남으므로 쌓인 것은 본 Table이 아닌 다른 자리에서 Archive 하고 Purge 해야 합니다.",
        ...
        },
        {
          ...
          desc_ko: "한 칸에 든 사람이 n명 미만이면 그 칸을 숨기는 규칙. 한 Snapshot 안에서만 참이라 공개본 두 개의 차이가 새 통로가 됩니다.",
        ...
        },
        {
          ...
          title_ko: "Fencing", title_ja: "Fencing",
          desc: "Making sure the original is off before recovery starts. Not answering is not the same as being dead, and if the original cannot be turned off nothing may be started.",
          desc_ko: "복구를 시작하기 전에 원본을 확실히 끄는 일. 응답이 없다는 것은 죽었다는 뜻이 아니고 끌 수 없으면 띄우면 안 됩니다.",
          desc_ja: "復旧を始める前に元を確実に切ること。応答が無いことは死んだという意味ではなく、切れなければ立ててはいけません。",
          date: "2026-09", dateLabel: "Sep 2026",
          tags: ["Fencing", "Reliability"]
        },
        {
          title: "Apdex",
        ...
        },
        {
          ...
          desc_ko: "측정 앞부분을 버리는 구간. 그 구간은 정상 상태가 아닙니다.",
