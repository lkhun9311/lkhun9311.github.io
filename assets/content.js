    ...
    writing: {
      ...
      items: [
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "고칠 근거를 못 찾은 Monitoring 성능 검토와, 뒤에 틀린 그 판단",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "Client 생성이 곧 Keystone 인증이라 프로젝트 수만큼 인증한 Monitoring 화면 초기 로드",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "못 찾은 project id마다 전체 목록을 다시 부른 Project Role Lookup의 1,409ms",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "Swap 포화와 삭제 표시 1,021행이 만든 Instance List의 54s",
        ...
        },
        {
          ...
          source: "company", sourceLabel: "Company work",
          title_ko: "외부 API에 키를 잠근 Cache가 만든 Volume List의 10min Timeout",
